...
if [[ $2 -eq 1 ]];then
	...
	cd $FLOW
	sudo -E ./build/FlowCount -l 27,28,29 --file-prefix flow --socket-mem 4096,4096 -b $LC1P1 -b $LC0P1 -b $LC0P0 > $EXP/flow_monitor_tx.dat &
	...
	cd $FLOW
	sudo -E ./build/FlowCount -l 8,9,10,11 --file-prefix flow --socket-mem 4096,4096 -b $LC1P1 -b $LC1P0 -b $LC0P0 >$EXP/flow_monitor.dat &
	sleep 30
...
#	sudo ./build/MoonGen experiments_traffic/single_tx.lua --dpdk-config=/home/vk/dpdk-conf-lc0.lua 0 -f $FLOWS -r 10000
#	sleep 60
#	sudo killall MoonGen
	echo -e "\nExperiment done\n"
	sleep 5
