...
plot \
'/home/vk/FAIRDROP_CPU_MASTER/in_out.dat'	u ($0+1-0.25):($3/1000000)   	t 'Fairdrop'  axes x1y1 with boxes lc rgb "black",	\
'/home/vk/vpp_cpu_faidrop_experiments/FAIRDROP_CPU_RESULTS_1/in_out_thf.dat'  u ($0+1):($3/1000000) t 'Old Fairdrop'   axes x1y1 with boxes lc rgb "red",\
'/home/vk/vpp_cpu_faidrop_experiments/NOFAIRDROP_CPU_RESULTS/in_out_nofdthf.dat'  u ($0+1+0.25):($3/1000000)	t 'Taildrop'   axes x1y1 with boxes lc rgb "grey"
