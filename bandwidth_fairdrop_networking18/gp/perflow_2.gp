...
plot \
'< sort -rnk1 /home/vk/FAIRDROP_BW_MASTER/TAILDROP_BW_1.0/plots/flow_pps.dat'    u ($0+1):($1/1000000)      t 'Taildrop Alpha-1.0'  axes x1y1 with lp pt 10 lc rgb "red",    \
